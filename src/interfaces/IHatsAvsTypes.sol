...
interface IHatsAvsTypes {
     ...
     */
    event StatusCheckTrigger(uint64 indexed triggerId, address indexed creator, uint256 hatId);
     ...
     */
    event EligibilityCheckTrigger(uint64 indexed triggerId, address indexed creator, address wearer, uint256 hatId);
     ...
     * @param standing Whether the wearer is in good standing
     */
    event EligibilityResultReceived(uint64 indexed triggerId, bool eligible, bool standing);
     ...
     * @param success Whether creation was successful
     */
    event HatCreationResultReceived(uint64 indexed triggerId, uint256 indexed hatId, bool success);
     ...
     * @param wearer The address that will wear the hat
     */
    event MintingTrigger(uint64 indexed triggerId, address indexed creator, uint256 hatId, address wearer);
    ...
    event HatMintingResultReceived(
        uint64 indexed triggerId, uint256 indexed hatId, address indexed wearer, bool success
    );
}
