...
/// @title SignerSyncManagerModule - A Zodiac module that can manage Safe signers
...
contract SignerSyncManagerModule is Module, IWavsServiceHandler {
  ...
  constructor(
    ...
    require(
      ...
      'SignerSyncManagerModule: invalid service manager'
    );
  ...
  function setUp(bytes memory initializeParams) public override {
    ...
    (
      ...
      IWavsServiceManager serviceManager
        ...
        initializeParams,
        (address, address, address, IWavsServiceManager)
      );
  ...
  function handleSignedEnvelope(
    ...
    // Decode the payload
    SignerManagerPayload memory payload = abi.decode(
      envelope.payload,
      (SignerManagerPayload)
    );
