      ...
      deployContracts: [
        ...
        },
        {
          ...
          args: (ctx) => [
            ...
            readJsonKey('.docker/eas_deploy.json', 'contracts.eas'),
            readJsonKey('.docker/eas_deploy.json', 'contracts.schema_registrar'),
            true,
            'dev',
            0,
            numNetworks,
      ...
      deployContracts: [
        {
          ...
          skip: () =>
            readJsonKeyIfFileExists('.docker/eas_deploy.json', 'contracts.eas') !==
            undefined,
        },
