      ...
      <div className="space-y-6">
        <div className="border border-gray-600 p-8 bg-gray-900/30 backdrop-blur-sm text-center">
          ...
          <p className="text-gray-400 mb-6">
            Connect your wallet to view your points and contributions to the collective.
          </p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border border-gray-700 bg-black/20 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="terminal-bright text-xl">{mockPointsData.attestationPoints}</span>
          </div>
        ...
        <div className="border border-gray-700 bg-black/20 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="terminal-bright text-xl">{mockPointsData.governancePoints}</span>
          </div>
        ...
        <div className="border border-gray-700 bg-black/20 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="terminal-bright text-xl">{mockPointsData.hyperstitionPoints}</span>
          </div>
        ...
        <div className="border border-gray-700 bg-black/20 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="terminal-bright text-xl">{mockPointsData.collectivePoints}</span>
          </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400 mt-1">
                    {activity.type.toUpperCase()} • {formatTimeAgo(activity.timestamp)}
                  </div>
                </div>
              </div>
      ...
      <div className="border border-yellow-600 p-6 bg-yellow-900/10 backdrop-blur-sm">
        <h3 className="text-lg font-bold text-yellow-400 mb-4">◈ ACTIVE MULTIPLIERS</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex items-center justify-between p-3 border border-yellow-700 bg-yellow-900/20">
            <div>
              <div className="text-white font-medium text-sm">Early Adopter</div>
          ...
          <div className="flex items-center justify-between p-3 border border-yellow-700 bg-yellow-900/20">
            <div>
              <div className="text-white font-medium text-sm">Consistency Bonus</div>
          ...
          <div className="flex items-center justify-between p-3 border border-yellow-700 bg-yellow-900/20">
            <div>
              <div className="text-white font-medium text-sm">Network Effect</div>
      ...
      <div className="border border-blue-600 p-6 bg-blue-900/10 backdrop-blur-sm">
        <h3 className="text-lg font-bold text-blue-400 mb-4">◇ HOW TO EARN POINTS</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              <span className="text-blue-400 mt-1">◆</span>
              <div>
                <div className="text-white font-medium">Create Attestations</div>
                <div className="text-gray-400">Verify truth statements and data integrity</div>
                <div className="text-blue-300 text-xs">+50-200 points per attestation</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <div className="text-white font-medium">Participate in Governance</div>
                <div className="text-gray-400">Vote on collective decisions</div>
                <div className="text-blue-300 text-xs">+25-100 points per vote</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <div className="text-white font-medium">Hyperstition Markets</div>
                <div className="text-gray-400">Create and trade prediction markets</div>
                <div className="text-blue-300 text-xs">+75-300 points per market</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-gray-400">Contribute to collective intelligence</div>
                <div className="text-blue-300 text-xs">+10-50 points per contribution</div>
              </div>
            </div>
          </div>
        </div>
