...
export default function VaultPage() {
  ...
  const handleDeposit = async () => {
    ...
    if (currentTVL + depositValue > VAULT_LIMIT) {
      alert(`Deposit would exceed vault limit of $${VAULT_LIMIT.toLocaleString()}. Maximum deposit: $${remainingCapacity.toLocaleString()}`);
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="border border-gray-600 p-6 bg-gray-900/30 backdrop-blur-sm">
        ...
        <p className="text-gray-400 text-sm">
          Deposit funds into EN0 from multiple blockchain networks. 
          All deposits are recorded on-chain and contribute to the collective treasury.
        </p>
      </div>
      ...
      <div className="border border-gray-600 p-6 bg-gray-900/20 backdrop-blur-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-xs">
            <span className="text-green-400">{vaultCapacityUsed.toFixed(1)}% FILLED</span>
      ...
      <div className="border border-blue-600 p-6 bg-blue-900/10 backdrop-blur-sm">
        <h2 className="text-lg font-bold text-blue-400 mb-4">◉ IMPORTANT NOTICE</h2>
        <div className="space-y-3 text-sm">
          <div className="flex items-start space-x-3">
            <span className="text-blue-400 text-lg">▲</span>
            <div>
              <div className="text-white font-medium mb-1">Hyperstition Market Participation</div>
              <div className="text-gray-300">
                Participants in the Hyperstition markets will receive attestations 
                regardless of whether they vote yes or no. Your participation in the 
                collective decision-making process is what matters for attestation rewards.
              </div>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-blue-400 text-lg">◢</span>
            <div>
              <div className="text-white font-medium mb-1">Vault Capacity Limit</div>
              <div className="text-gray-300">
                This vault has a maximum capacity of $1,000,000 USD as part of the 
                experimental protocol design. Deposits will be rejected once this limit is reached.
              </div>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-blue-400 text-lg">◤</span>
            <div>
              <div className="text-white font-medium mb-1">Experimental Nature</div>
              <div className="text-gray-300">
                All deposits are contributions to an active experiment in collective 
                intelligence and blockchain-based governance. Proceed with full understanding 
      ...
      {/* Chain Selector */}
      <div className="border border-gray-600 p-6 bg-gray-900/20 backdrop-blur-sm">
        <h2 className="text-lg font-bold text-white mb-4">SELECT BLOCKCHAIN NETWORK</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-yellow-600 p-3 bg-yellow-900/10">
                <div className="text-xs text-yellow-400 space-y-2">
                  <div>⚠️ WARNING: This is experimental software. Deposits are recorded on public blockchain 
                  and contribute to the EN0 experiment treasury. Proceed at your own risk.</div>
                  <div>📊 VAULT CAPACITY: ${currentTVL.toLocaleString()} / ${VAULT_LIMIT.toLocaleString()} 
                  (${remainingCapacity.toLocaleString()} remaining)</div>
                </div>
              </div>
