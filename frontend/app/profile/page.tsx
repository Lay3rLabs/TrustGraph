      ...
      <div className="space-y-8">
        ...
        <div className="border border-gray-700 bg-black/5 p-8 rounded-sm text-center">
          <div className="space-y-4">
            <div className="terminal-command text-red-400 text-lg">
    ...
    return (
      <div className="space-y-8">
        <SectionHeader
          ...
          description="Your consciousness has been integrated into the collective intelligence system. Explore your digital identity below and use the navigation menu to participate in active experiments."
        />
          ...
          <div className="lg:col-span-2 border border-gray-700 bg-black/10 p-6 rounded-sm">
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="terminal-text text-xs">
                    Collective Node since: {new Date().toLocaleDateString()}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-700">
                ...
                <div>
                  <div className="terminal-dim text-xs">ATTESTATIONS MADE</div>
                  <div className="terminal-bright text-lg">0</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="terminal-bright text-lg">
                    {profileData.selectedGoals.length}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="terminal-dim text-xs">
                  {isConnected
                    ...
                    : 'Connect wallet to establish link'}
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-700 bg-black/10 p-4 rounded-sm">
              <div className="space-y-2">
                ...
                <div className="terminal-dim text-xs">
                  Participate to increase weight
                </div>
              </div>
            </div>
          ...
          <div className="border border-gray-700 bg-black/5 p-6 rounded-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                .filter((id) => profileData.selectedGoals.includes(id))
                .map((id) => {
                  ...
                  return (
                    <div
                      key={id}
                      className="flex items-center space-x-3 p-3 border border-gray-700 bg-black/10 rounded-sm"
                    >
                      <span className="terminal-bright text-lg">
                        {goal.icon}
                      </span>
                      <div className="terminal-text text-sm">{goal.label}</div>
                      <div className="ml-auto text-xs terminal-bright">
                        ENROLLED
                      </div>
                    </div>
                  )
            ...
            {[
              {
                ...
                status: 'verified',
                description: 'Basic identity profile established',
              },
              {
                type: 'Wallet Connection',
                status: isConnected ? 'verified' : 'pending',
                description: 'Ethereum wallet linked for authentication',
              },
              {
                type: 'Experiment Enrollment',
                status: 'verified',
                description: `Enrolled in ${profileData.selectedGoals.length} experiment domains`,
              },
              {
                type: 'Reputation Building',
                status: 'pending',
                description: 'Participate in experiments to build reputation',
              },
              {
                type: 'Attestation Network',
                status: 'pending',
                description: 'Give and receive attestations to expand network',
              },
              {
                type: 'Governance Participation',
                status: 'pending',
                description:
                  'Vote on collective decisions to increase influence',
              },
            ].map((verification, index) => (
              <div
                key={index}
                className="border border-gray-700 bg-black/5 p-4 rounded-sm"
              >
                <div className="space-y-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <div className="terminal-text text-sm">
                  Navigate to Attestations to verify your identity and build
                  reputation
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div className="terminal-text text-sm">
                  Explore Governance to participate in collective
                  decision-making
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div className="terminal-text text-sm">
                  Visit Hyperstition Markets to engage with prediction markets
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <span className="terminal-bright">4.</span>
                <div className="terminal-text text-sm">
                  Check Rewards to track your participation incentives
                </div>
              </div>
            </div>
          </div>
