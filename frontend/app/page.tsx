...
const initialMessages = [
  ...
  {
    type: 'output',
    content: 'EN0VA is an EXPERIMENTAL PROTOCOL exploring collective',
    style: 'system-message',
  },
  {
    type: 'output',
    content: 'intelligence, blockchain technology, and emergent digital',
    style: 'system-message',
  },
  {
    type: 'output',
    content: 'consciousness through distributed decision-making systems and',
    style: 'system-message',
  },
  {
    type: 'output',
    content: 'novel pyschotechnologies.',
    style: 'system-message',
  },
  { type: 'output', content: '\n' },
  {
