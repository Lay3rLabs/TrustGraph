...
contract MerkleGovModuleTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy mock service manager and merkle helper
        ...
        govModule = new MerkleGovModule(owner, address(safe), address(safe), mockServiceManager);
    ...
    function _setupMerkleTree() internal {
        ...
        // Update merkle root via WAVS
        _updateMerkleRootViaWAVS(merkleRoot, bytes32(uint256(0x1234)));
    }
    ...
    function test_MerkleRootUpdateDuringVoting() public {
        ...
        _updateMerkleRootViaWAVS(newRoot, bytes32(uint256(0x5678)));
        ...
        vm.prank(alice);
        uint256 newProposalId = govModule.propose(targets, values, calldatas, operations, "New proposal");
