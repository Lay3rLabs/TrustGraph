...
contract DeployEASTest is Test {
    ...
    function testDeployEAS_ShouldDeployAllContracts() public {
        ...
        assertTrue(
            ...
            "EASIndexerResolver not deployed"
        );
        assertTrue(
    ...
    function testDeployEAS_ShouldRegisterSchemasWithEASIndexerResolver()
        public
    {
        string memory serviceManagerAddr = vm.toString(
            address(mockServiceManager)
    ...
    function testDeployEAS_ShouldConfigureAttesterCorrectly() public {
        ...
        assertTrue(
            ...
            "WavsAttester should be deployed"
        );
    }
    ...
    function testDeployEAS_ShouldProduceConsistentDeployment() public {
        ...
        assertTrue(
            ...
            "Should deploy new EASIndexerResolver instance"
        );
        ...
        assertTrue(
            ...
            "Second deployment should have valid EASIndexerResolver"
        );
    }
}
