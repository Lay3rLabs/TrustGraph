...
AGGREGATOR_URL=${AGGREGATOR_URL:-"http://127.0.0.1:8040"}
...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:1.5.1 wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
