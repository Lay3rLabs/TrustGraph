...
BASE_CMD="docker run --rm --network host -w /data -v $(pwd):/data ghcr.io/lay3rlabs/wavs:0.6.0-beta.1 wavs-cli service --json true --home /data --file /data/${FILE_LOCATION}"
