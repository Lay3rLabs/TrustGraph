                    ...
                    start_time: match l37 {
                        ...
                        1 => {
                            let e = {
                                ...
                                wavs::types::core::Timestamp { nanos: l38 as u64 }
                            };
                            Some(e)
                        }
                        _ => _rt::invalid_enum_discriminant(),
                    ...
                    end_time: match l39 {
                        ...
                        1 => {
                            let e = {
                                ...
                                wavs::types::core::Timestamp { nanos: l40 as u64 }
                            };
                            Some(e)
                        }
                        _ => _rt::invalid_enum_discriminant(),
        ...
        3 => {
            let e87 = {
                ...
                wavs::worker::input::TriggerDataCron {
                    trigger_time: wavs::types::core::Timestamp { nanos: l83 as u64 },
                }
            };
            V87::Cron(e87)
        }
...
pub mod wasi {
    ...
    pub mod keyvalue {
        ...
        pub mod store {
            ...
            impl Bucket {
                #[allow(unused_unsafe, clippy::all)]
                pub fn list_keys(&self, cursor: Option<&str>) -> Result<KeyResponse, Error> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 24]);
                        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 24]);
                        ...
                        wit_import((self).handle() as i32, result1_0, result1_1, result1_2, ptr2);
                        let l3 = i32::from(*ptr2.add(0).cast::<u8>());
                        match l3 {
                            0 => {
                                let e = {
        ...
        pub mod atomics {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn increment(bucket: &Bucket, key: &str, delta: i64) -> Result<i64, Error> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 24]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 24]);
            ...
            pub fn swap(cas: Cas, value: &[u8]) -> Result<(), CasError> {
                unsafe {
                    ...
                    wit_import((&cas).take_handle() as i32, ptr0.cast_mut(), len0, ptr1);
                    let l2 = i32::from(*ptr1.add(0).cast::<u8>());
                    match l2 {
                        0 => {
                            let e = ();
                            ...
                            let e = {
                                ...
                                let v10 = match l3 {
                                    0 => {
                                        ...
                                        CasError::StoreError(e10)
                                    }
                                    n => {
                                        debug_assert_eq!(n, 1, "invalid enum discriminant");
                                        let e10 = {
                                            let l9 = *ptr1.add(8).cast::<i32>();
                                            Cas::from_handle(l9 as u32)
                                        };
                                        CasError::CasFailed(e10)
                                    }
                                };
                                v10
                            };
    ...
    pub mod types {
        ...
        pub mod service {
            ...
            impl ::core::fmt::Debug for ServiceStatus {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ServiceStatus::Active => f.debug_tuple("ServiceStatus::Active").finish(),
                        ServiceStatus::Paused => f.debug_tuple("ServiceStatus::Paused").finish(),
                    }
                }
            }
            #[derive(Clone)]
                ...
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        AllowedHostPermission::Only(e) => {
                            f.debug_tuple("AllowedHostPermission::Only").field(e).finish()
                        }
                ...
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        Trigger::CosmosContractEvent(e) => {
                            f.debug_tuple("Trigger::CosmosContractEvent").field(e).finish()
                        }
                        Trigger::BlockInterval(e) => {
                            f.debug_tuple("Trigger::BlockInterval").field(e).finish()
                        }
                        Trigger::Cron(e) => f.debug_tuple("Trigger::Cron").field(e).finish(),
...
pub mod host {
    ...
    pub type ServiceAndWorkflowId = super::wavs::worker::helpers::ServiceAndWorkflowId;
    pub type WorkflowAndWorkflowId = super::wavs::worker::helpers::WorkflowAndWorkflowId;
    #[allow(unused_unsafe, clippy::all)]
    ...
    pub fn get_service() -> ServiceAndWorkflowId {
        unsafe {
            ...
            let base182 = l4;
            let len182 = l5;
            let mut result182 = _rt::Vec::with_capacity(len182);
            for i in 0..len182 {
                let base = base182.add(i * 336);
                let e182 = {
                    let l6 = *base.add(0).cast::<*mut u8>();
                    let l7 = *base.add(4).cast::<usize>();
                    let len8 = l7;
                    ...
                    use super::wavs::types::service::Trigger as V44;
                    let v44 = match l9 {
                        0 => {
                            let e44 = {
                                ...
                                super::wavs::types::service::TriggerEvmContractEvent {
                                    ...
                                    chain_name: _rt::string_lift(bytes15),
                                    event_hash: _rt::Vec::from_raw_parts(l16.cast(), len18, len18),
                                }
                            };
                            V44::EvmContractEvent(e44)
                        }
                        1 => {
                            let e44 = {
                                ...
                                let len21 = l20;
                                let bytes21 = _rt::Vec::from_raw_parts(l19.cast(), len21, len21);
                                let l22 = *base.add(24).cast::<i32>();
                                let l23 = *base.add(28).cast::<*mut u8>();
                                let l24 = *base.add(32).cast::<usize>();
                                let len25 = l24;
                                let bytes25 = _rt::Vec::from_raw_parts(l23.cast(), len25, len25);
                                let l26 = *base.add(36).cast::<*mut u8>();
                                let l27 = *base.add(40).cast::<usize>();
                                let len28 = l27;
                                let bytes28 = _rt::Vec::from_raw_parts(l26.cast(), len28, len28);
                                super::wavs::types::service::TriggerCosmosContractEvent {
                                    address: super::wavs::types::chain::CosmosAddress {
                                        bech32_addr: _rt::string_lift(bytes21),
                                        prefix_len: l22 as u32,
                                    },
                                    chain_name: _rt::string_lift(bytes25),
                                    event_type: _rt::string_lift(bytes28),
                                }
                            };
                            V44::CosmosContractEvent(e44)
                        }
                        2 => {
                            let e44 = {
                                ...
                                let l32 = *base.add(24).cast::<i32>();
                                let l33 = i32::from(*base.add(32).cast::<u8>());
                                let l35 = i32::from(*base.add(48).cast::<u8>());
                                super::wavs::types::service::TriggerBlockInterval {
                                    chain_name: _rt::string_lift(bytes31),
                                    n_blocks: l32 as u32,
                                    start_block: match l33 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l34 = *base.add(40).cast::<i64>();
                                                l34 as u64
                                            };
                                            Some(e)
                                        }
                            ...
                            V44::BlockInterval(e44)
                        }
                        3 => {
                            let e44 = {
                                let l37 = *base.add(16).cast::<*mut u8>();
                                let l38 = *base.add(20).cast::<usize>();
                                let len39 = l38;
                                let bytes39 = _rt::Vec::from_raw_parts(l37.cast(), len39, len39);
                                let l40 = i32::from(*base.add(24).cast::<u8>());
                                let l42 = i32::from(*base.add(40).cast::<u8>());
                                super::wavs::types::service::TriggerCron {
                                    schedule: _rt::string_lift(bytes39),
                                    start_time: match l40 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l41 = *base.add(32).cast::<i64>();
                    ...
                    let l45 = i32::from(*base.add(64).cast::<u8>());
                    use super::wavs::types::service::ComponentSource as V69;
                    let v69 = match l45 {
                        0 => {
                            let e69 = {
                                let l46 = *base.add(68).cast::<*mut u8>();
                                let l47 = *base.add(72).cast::<usize>();
                                let len48 = l47;
                                let bytes48 = _rt::Vec::from_raw_parts(l46.cast(), len48, len48);
                                let l49 = *base.add(76).cast::<*mut u8>();
                                let l50 = *base.add(80).cast::<usize>();
                                let len51 = l50;
                                let bytes51 = _rt::Vec::from_raw_parts(l49.cast(), len51, len51);
                                super::wavs::types::service::ComponentSourceDownload {
                                    url: _rt::string_lift(bytes48),
                                    digest: _rt::string_lift(bytes51),
                                }
                            };
                            V69::Download(e69)
                        }
                        1 => {
                            let e69 = {
                                let l52 = *base.add(68).cast::<*mut u8>();
                                let l53 = *base.add(72).cast::<usize>();
                                let len54 = l53;
                                let bytes54 = _rt::Vec::from_raw_parts(l52.cast(), len54, len54);
                                let l55 = i32::from(*base.add(76).cast::<u8>());
                                let l59 = i32::from(*base.add(88).cast::<u8>());
                                let l63 = *base.add(100).cast::<*mut u8>();
                                let l64 = *base.add(104).cast::<usize>();
                                let len65 = l64;
                                let bytes65 = _rt::Vec::from_raw_parts(l63.cast(), len65, len65);
                                super::wavs::types::service::Registry {
                                    digest: _rt::string_lift(bytes54),
                                    domain: match l55 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l56 = *base.add(80).cast::<*mut u8>();
                                                let l57 = *base.add(84).cast::<usize>();
                                                let len58 = l57;
                                                let bytes58 = _rt::Vec::from_raw_parts(
                                                    l56.cast(),
                                                    len58,
                                    ...
                                    version: match l59 {
                                        ...
                                        1 => {
                                            let e = {
                                                let l60 = *base.add(92).cast::<*mut u8>();
                                                let l61 = *base.add(96).cast::<usize>();
                                                let len62 = l61;
                                                let bytes62 = _rt::Vec::from_raw_parts(
                                                    l60.cast(),
                                                    len62,
                        ...
                        n => {
                            debug_assert_eq!(n, 2, "invalid enum discriminant");
                            let e69 = {
                                let l66 = *base.add(68).cast::<*mut u8>();
                                let l67 = *base.add(72).cast::<usize>();
                                let len68 = l67;
                                let bytes68 = _rt::Vec::from_raw_parts(l66.cast(), len68, len68);
                    ...
                    let l70 = i32::from(*base.add(108).cast::<u8>());
                    use super::wavs::types::service::AllowedHostPermission as V77;
                    let v77 = match l70 {
                        0 => V77::All,
                        1 => {
                            let e77 = {
                                let l71 = *base.add(112).cast::<*mut u8>();
                                let l72 = *base.add(116).cast::<usize>();
                                let base76 = l71;
                                let len76 = l72;
                    ...
                    let l78 = i32::from(*base.add(120).cast::<u8>());
                    let l79 = i32::from(*base.add(128).cast::<u8>());
                    let l81 = i32::from(*base.add(144).cast::<u8>());
                    let l83 = *base.add(160).cast::<*mut u8>();
                    let l84 = *base.add(164).cast::<usize>();
                    let base91 = l83;
                    let len91 = l84;
                    let mut result91 = _rt::Vec::with_capacity(len91);
                    for i in 0..len91 {
                        let base = base91.add(i * 16);
                        let e91 = {
                            let l85 = *base.add(0).cast::<*mut u8>();
                            let l86 = *base.add(4).cast::<usize>();
                            let len87 = l86;
                            ...
                            (_rt::string_lift(bytes87), _rt::string_lift(bytes90))
                        };
                        result91.push(e91);
                    }
                    _rt::cabi_dealloc(base91, len91 * 16, 4);
                    let l92 = *base.add(168).cast::<*mut u8>();
                    let l93 = *base.add(172).cast::<usize>();
                    let base97 = l92;
                    let len97 = l93;
                    let mut result97 = _rt::Vec::with_capacity(len97);
                    for i in 0..len97 {
                        let base = base97.add(i * 8);
                        let e97 = {
                            let l94 = *base.add(0).cast::<*mut u8>();
                            let l95 = *base.add(4).cast::<usize>();
                            let len96 = l95;
                    ...
                    _rt::cabi_dealloc(base97, len97 * 8, 4);
                    let l98 = i32::from(*base.add(176).cast::<u8>());
                    use super::wavs::types::service::Submit as V181;
                    let v181 = match l98 {
                        0 => V181::None,
                        n => {
                            debug_assert_eq!(n, 1, "invalid enum discriminant");
                            let e181 = {
                                let l99 = *base.add(184).cast::<*mut u8>();
                                let l100 = *base.add(188).cast::<usize>();
                                let len101 = l100;
                                let bytes101 = _rt::Vec::from_raw_parts(l99.cast(), len101, len101);
                                let l102 = i32::from(*base.add(192).cast::<u8>());
                                let l156 = i32::from(*base.add(312).cast::<u8>());
                                let l168 = i32::from(*base.add(324).cast::<u8>());
                                super::wavs::types::service::AggregatorSubmit {
                                    url: _rt::string_lift(bytes101),
                                    component: match l102 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l103 = i32::from(*base.add(200).cast::<u8>());
                                                use super::wavs::types::service::ComponentSource as V127;
                                                let v127 = match l103 {
                                                    0 => {
                                                        let e127 = {
                                                            let l104 =
                                                                *base.add(204).cast::<*mut u8>();
                                                            let l105 =
                                                                *base.add(208).cast::<usize>();
                                                            let len106 = l105;
                                                            ...
                                                            let l107 =
                                                                *base.add(212).cast::<*mut u8>();
                                                            let l108 =
                                                                *base.add(216).cast::<usize>();
                                                            let len109 = l108;
                                                    ...
                                                    1 => {
                                                        let e127 = {
                                                            ...
                                                            let l113 = i32::from(
                                                                *base.add(212).cast::<u8>(),
                                                            );
                                                            let l117 = i32::from(
                                                                *base.add(224).cast::<u8>(),
                                                            );
                                                            let l121 =
                                                                *base.add(236).cast::<*mut u8>();
                                                            let l122 =
                                                                *base.add(240).cast::<usize>();
                                                            let len123 = l122;
                                                            ...
                                                            super::wavs::types::service::Registry {
                                                                ...
                                                                domain: match l113 {
                                                                    ...
                                                                    1 => {
                                                                        let e = {
                                                                            let l114 = *base.add(216).cast::<*mut u8>();
                                                                            let l115 = *base.add(220).cast::<usize>();
                                                                            let len116 = l115;
                                                                ...
                                                                version: match l117 {
                                                                    ...
                                                                    1 => {
                                                                        let e = {
                                                                            let l118 = *base.add(228).cast::<*mut u8>();
                                                                            let l119 = *base.add(232).cast::<usize>();
                                                                            let len120 = l119;
                                                ...
                                                let l128 = i32::from(*base.add(244).cast::<u8>());
                                                ...
                                                let v135 = match l128 {
                                                    ...
                                                    1 => {
                                                        let e135 = {
                                                            let l129 =
                                                                *base.add(248).cast::<*mut u8>();
                                                            let l130 =
                                                                *base.add(252).cast::<usize>();
                                                            let base134 = l129;
                                                            let len134 = l130;
                                                            let mut result134 =
                                                                _rt::Vec::with_capacity(len134);
                                                            for i in 0..len134 {
                                                ...
                                                let l136 = i32::from(*base.add(256).cast::<u8>());
                                                let l137 = i32::from(*base.add(264).cast::<u8>());
                                                let l139 = i32::from(*base.add(280).cast::<u8>());
                                                let l141 = *base.add(296).cast::<*mut u8>();
                                                let l142 = *base.add(300).cast::<usize>();
                                                let base149 = l141;
                                                let len149 = l142;
                                                let mut result149 = _rt::Vec::with_capacity(len149);
                                                for i in 0..len149 {
                                                    let base = base149.add(i * 16);
                                                    let e149 = {
                                                        let l143 = *base.add(0).cast::<*mut u8>();
                                                        let l144 = *base.add(4).cast::<usize>();
                                                        let len145 = l144;
                                                ...
                                                _rt::cabi_dealloc(base149, len149 * 16, 4);
                                                let l150 = *base.add(304).cast::<*mut u8>();
                                                let l151 = *base.add(308).cast::<usize>();
                                                let base155 = l150;
                                                let len155 = l151;
                                                let mut result155 = _rt::Vec::with_capacity(len155);
                                                for i in 0..len155 {
                                                    let base = base155.add(i * 8);
                                                    let e155 = {
                                                        let l152 = *base.add(0).cast::<*mut u8>();
                                                        let l153 = *base.add(4).cast::<usize>();
                                                        let len154 = l153;
                                                ...
                                                _rt::cabi_dealloc(base155, len155 * 8, 4);
                                                super::wavs::types::service::Component {
                                                    source: v127,
                                                    permissions:
                                                        super::wavs::types::service::Permissions {
                                    ...
                                    evm_contracts: match l156 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l157 = *base.add(316).cast::<*mut u8>();
                                                let l158 = *base.add(320).cast::<usize>();
                                                let base167 = l157;
                                                let len167 = l158;
                                                let mut result167 = _rt::Vec::with_capacity(len167);
                                                for i in 0..len167 {
                                                    let base = base167.add(i * 32);
                                                    let e167 = {
                                                        let l159 = *base.add(0).cast::<*mut u8>();
                                                        let l160 = *base.add(4).cast::<usize>();
                                                        let len161 = l160;
                                                        ...
                                                        let l163 = *base.add(12).cast::<usize>();
                                                        let len164 = l163;
                                                        let l165 =
                                                            i32::from(*base.add(16).cast::<u8>());
                                                        super::wavs::types::service::EvmContractSubmission {
                                                ...
                                                _rt::cabi_dealloc(base167, len167 * 32, 8);
                                                result167
                                            };
                                            Some(e)
                                        }
                                    ...
                                    cosmos_contracts: match l168 {
                                        0 => None,
                                        1 => {
                                            let e = {
                                                let l169 = *base.add(328).cast::<*mut u8>();
                                                let l170 = *base.add(332).cast::<usize>();
                                                let base180 = l169;
                                                let len180 = l170;
                                                let mut result180 = _rt::Vec::with_capacity(len180);
                                                for i in 0..len180 {
                                                    let base = base180.add(i * 40);
                                                    let e180 = {
                                                        ...
                                                        let l177 = *base.add(16).cast::<i32>();
                                                        let l178 =
                                                            i32::from(*base.add(24).cast::<u8>());
                                                        super::wavs::types::service::CosmosContractSubmission {
                                                            chain_name: _rt::string_lift(bytes173),
                                                            address: super::wavs::types::chain::CosmosAddress {
                                                                bech32_addr: _rt::string_lift(bytes176),
                                                                prefix_len: l177 as u32,
                                                            },
                                                            max_gas: match l178 {
                                                                0 => None,
                                                                1 => {
                                                                    let e = {
                                                                        let l179 = *base.add(32).cast::<i64>();
                                                                        l179 as u64
                                                                    };
                                                                    Some(e)
                                                                }
                                                ...
                                                _rt::cabi_dealloc(base180, len180 * 40, 8);
                                                result180
                                            };
                                            Some(e)
                                        }
                        ...
                        super::wavs::types::service::Workflow {
                            ...
                            component: super::wavs::types::service::Component {
                                ...
                                permissions: super::wavs::types::service::Permissions {
                                    allowed_http_hosts: v77,
                                    file_system: _rt::bool_lift(l78 as u8),
                                },
                                fuel_limit: match l79 {
                                    0 => None,
                                    1 => {
                                        let e = {
                                            let l80 = *base.add(136).cast::<i64>();
                                            l80 as u64
                                        };
                                        Some(e)
                                    }
                                ...
                                time_limit_seconds: match l81 {
                                    0 => None,
                                    1 => {
                                        let e = {
                                            let l82 = *base.add(152).cast::<i64>();
                                            l82 as u64
                                        };
                                        Some(e)
                                    }
            ...
            _rt::cabi_dealloc(base182, len182 * 336, 8);
            let l183 = i32::from(*ptr0.add(16).cast::<u8>());
            use super::wavs::types::service::ServiceStatus as V184;
            let v184 = match l183 {
                0 => V184::Active,
                n => {
                    debug_assert_eq!(n, 1, "invalid enum discriminant");
            ...
            let l185 = i32::from(*ptr0.add(20).cast::<u8>());
            use super::wavs::types::service::ServiceManager as V199;
            let v199 = match l185 {
                0 => {
                    let e199 = {
                        let l186 = *ptr0.add(24).cast::<*mut u8>();
                        let l187 = *ptr0.add(28).cast::<usize>();
                        let len188 = l187;
                        let bytes188 = _rt::Vec::from_raw_parts(l186.cast(), len188, len188);
                        let l189 = *ptr0.add(32).cast::<*mut u8>();
                        let l190 = *ptr0.add(36).cast::<usize>();
                        let len191 = l190;
                        super::wavs::types::service::EvmManager {
                            chain_name: _rt::string_lift(bytes188),
                            address: super::wavs::types::chain::EvmAddress {
                                raw_bytes: _rt::Vec::from_raw_parts(l189.cast(), len191, len191),
                            },
                        }
                    };
                    V199::Evm(e199)
                ...
                n => {
                    debug_assert_eq!(n, 1, "invalid enum discriminant");
                    let e199 = {
                        let l192 = *ptr0.add(24).cast::<*mut u8>();
                        let l193 = *ptr0.add(28).cast::<usize>();
                        let len194 = l193;
                        let bytes194 = _rt::Vec::from_raw_parts(l192.cast(), len194, len194);
                        let l195 = *ptr0.add(32).cast::<*mut u8>();
                        let l196 = *ptr0.add(36).cast::<usize>();
                        let len197 = l196;
                        let bytes197 = _rt::Vec::from_raw_parts(l195.cast(), len197, len197);
                        let l198 = *ptr0.add(40).cast::<i32>();
                        super::wavs::types::service::CosmosManager {
                            chain_name: _rt::string_lift(bytes194),
                            address: super::wavs::types::chain::CosmosAddress {
                                bech32_addr: _rt::string_lift(bytes197),
                                prefix_len: l198 as u32,
                            },
                        }
                    };
                    V199::Cosmos(e199)
            ...
            let l200 = *ptr0.add(44).cast::<*mut u8>();
            let l201 = *ptr0.add(48).cast::<usize>();
            let len202 = l201;
            let bytes202 = _rt::Vec::from_raw_parts(l200.cast(), len202, len202);
            let l203 = *ptr0.add(52).cast::<*mut u8>();
            let l204 = *ptr0.add(56).cast::<usize>();
            let len205 = l204;
            let bytes205 = _rt::Vec::from_raw_parts(l203.cast(), len205, len205);
            super::wavs::worker::helpers::ServiceAndWorkflowId {
                ...
                service_id: _rt::string_lift(bytes202),
                workflow_id: _rt::string_lift(bytes205),
            }
        }
    }
    #[allow(unused_unsafe, clippy::all)]
    ...
    pub fn get_workflow() -> WorkflowAndWorkflowId {
        unsafe {
            #[repr(align(8))]
            struct RetArea([::core::mem::MaybeUninit<u8>; 336]);
            let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 336]);
            let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
            #[cfg(target_arch = "wasm32")]
            #[link(wasm_import_module = "host")]
            extern "C" {
            ...
            wit_import(ptr0);
            let l1 = i32::from(*ptr0.add(0).cast::<u8>());
            use super::wavs::types::service::Trigger as V36;
            let v36 = match l1 {
                0 => {
                    let e36 = {
                        ...
                        super::wavs::types::service::TriggerEvmContractEvent {
                            address: super::wavs::types::chain::EvmAddress {
                                raw_bytes: _rt::Vec::from_raw_parts(l2.cast(), len4, len4),
                            },
                            chain_name: _rt::string_lift(bytes7),
                            event_hash: _rt::Vec::from_raw_parts(l8.cast(), len10, len10),
                        }
                    };
                    V36::EvmContractEvent(e36)
                }
                1 => {
                    let e36 = {
                        ...
                        let l14 = *ptr0.add(16).cast::<i32>();
                        let l15 = *ptr0.add(20).cast::<*mut u8>();
                        let l16 = *ptr0.add(24).cast::<usize>();
                        let len17 = l16;
                        let bytes17 = _rt::Vec::from_raw_parts(l15.cast(), len17, len17);
                        let l18 = *ptr0.add(28).cast::<*mut u8>();
                        let l19 = *ptr0.add(32).cast::<usize>();
                        let len20 = l19;
                        let bytes20 = _rt::Vec::from_raw_parts(l18.cast(), len20, len20);
                        super::wavs::types::service::TriggerCosmosContractEvent {
                            address: super::wavs::types::chain::CosmosAddress {
                                bech32_addr: _rt::string_lift(bytes13),
                                prefix_len: l14 as u32,
                            },
                            chain_name: _rt::string_lift(bytes17),
                            event_type: _rt::string_lift(bytes20),
                        }
                    };
                    V36::CosmosContractEvent(e36)
                }
                2 => {
                    let e36 = {
                        ...
                        let l24 = *ptr0.add(16).cast::<i32>();
                        let l25 = i32::from(*ptr0.add(24).cast::<u8>());
                        let l27 = i32::from(*ptr0.add(40).cast::<u8>());
                        super::wavs::types::service::TriggerBlockInterval {
                            chain_name: _rt::string_lift(bytes23),
                            n_blocks: l24 as u32,
                            start_block: match l25 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l26 = *ptr0.add(32).cast::<i64>();
                                        l26 as u64
                                    };
                                    Some(e)
                                }
                    ...
                    V36::BlockInterval(e36)
                }
                3 => {
                    let e36 = {
                        let l29 = *ptr0.add(8).cast::<*mut u8>();
                        let l30 = *ptr0.add(12).cast::<usize>();
                        let len31 = l30;
                        let bytes31 = _rt::Vec::from_raw_parts(l29.cast(), len31, len31);
                        let l32 = i32::from(*ptr0.add(16).cast::<u8>());
                        let l34 = i32::from(*ptr0.add(32).cast::<u8>());
                        super::wavs::types::service::TriggerCron {
                            schedule: _rt::string_lift(bytes31),
                            start_time: match l32 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l33 = *ptr0.add(24).cast::<i64>();
                                        super::wavs::types::core::Timestamp { nanos: l33 as u64 }
                                    };
                                    Some(e)
                                }
                                _ => _rt::invalid_enum_discriminant(),
                            ...
                            end_time: match l34 {
                                ...
                                1 => {
                                    let e = {
                                        let l35 = *ptr0.add(40).cast::<i64>();
                                        super::wavs::types::core::Timestamp { nanos: l35 as u64 }
                                    };
                                    Some(e)
                                }
                                _ => _rt::invalid_enum_discriminant(),
            ...
            let l37 = i32::from(*ptr0.add(56).cast::<u8>());
            use super::wavs::types::service::ComponentSource as V61;
            let v61 = match l37 {
                0 => {
                    let e61 = {
                        let l38 = *ptr0.add(60).cast::<*mut u8>();
                        let l39 = *ptr0.add(64).cast::<usize>();
                        let len40 = l39;
                        let bytes40 = _rt::Vec::from_raw_parts(l38.cast(), len40, len40);
                        let l41 = *ptr0.add(68).cast::<*mut u8>();
                        let l42 = *ptr0.add(72).cast::<usize>();
                        let len43 = l42;
                        let bytes43 = _rt::Vec::from_raw_parts(l41.cast(), len43, len43);
                        super::wavs::types::service::ComponentSourceDownload {
                            url: _rt::string_lift(bytes40),
                            digest: _rt::string_lift(bytes43),
                        }
                    };
                    V61::Download(e61)
                }
                1 => {
                    let e61 = {
                        let l44 = *ptr0.add(60).cast::<*mut u8>();
                        let l45 = *ptr0.add(64).cast::<usize>();
                        let len46 = l45;
                        let bytes46 = _rt::Vec::from_raw_parts(l44.cast(), len46, len46);
                        let l47 = i32::from(*ptr0.add(68).cast::<u8>());
                        let l51 = i32::from(*ptr0.add(80).cast::<u8>());
                        let l55 = *ptr0.add(92).cast::<*mut u8>();
                        let l56 = *ptr0.add(96).cast::<usize>();
                        let len57 = l56;
                        let bytes57 = _rt::Vec::from_raw_parts(l55.cast(), len57, len57);
                        super::wavs::types::service::Registry {
                            digest: _rt::string_lift(bytes46),
                            domain: match l47 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l48 = *ptr0.add(72).cast::<*mut u8>();
                                        let l49 = *ptr0.add(76).cast::<usize>();
                                        let len50 = l49;
                                        let bytes50 =
                            ...
                            version: match l51 {
                                ...
                                1 => {
                                    let e = {
                                        let l52 = *ptr0.add(84).cast::<*mut u8>();
                                        let l53 = *ptr0.add(88).cast::<usize>();
                                        let len54 = l53;
                                        let bytes54 =
                ...
                n => {
                    debug_assert_eq!(n, 2, "invalid enum discriminant");
                    let e61 = {
                        let l58 = *ptr0.add(60).cast::<*mut u8>();
                        let l59 = *ptr0.add(64).cast::<usize>();
                        let len60 = l59;
            ...
            let l62 = i32::from(*ptr0.add(100).cast::<u8>());
            use super::wavs::types::service::AllowedHostPermission as V69;
            let v69 = match l62 {
                0 => V69::All,
                1 => {
                    let e69 = {
                        let l63 = *ptr0.add(104).cast::<*mut u8>();
                        let l64 = *ptr0.add(108).cast::<usize>();
                        let base68 = l63;
                        let len68 = l64;
            ...
            let l70 = i32::from(*ptr0.add(112).cast::<u8>());
            let l71 = i32::from(*ptr0.add(120).cast::<u8>());
            let l73 = i32::from(*ptr0.add(136).cast::<u8>());
            let l75 = *ptr0.add(152).cast::<*mut u8>();
            let l76 = *ptr0.add(156).cast::<usize>();
            let base83 = l75;
            let len83 = l76;
            let mut result83 = _rt::Vec::with_capacity(len83);
            for i in 0..len83 {
                let base = base83.add(i * 16);
                let e83 = {
            ...
            _rt::cabi_dealloc(base83, len83 * 16, 4);
            let l84 = *ptr0.add(160).cast::<*mut u8>();
            let l85 = *ptr0.add(164).cast::<usize>();
            let base89 = l84;
            let len89 = l85;
            ...
            let l90 = i32::from(*ptr0.add(168).cast::<u8>());
            use super::wavs::types::service::Submit as V173;
            let v173 = match l90 {
                0 => V173::None,
                n => {
                    debug_assert_eq!(n, 1, "invalid enum discriminant");
                    let e173 = {
                        let l91 = *ptr0.add(176).cast::<*mut u8>();
                        let l92 = *ptr0.add(180).cast::<usize>();
                        let len93 = l92;
                        let bytes93 = _rt::Vec::from_raw_parts(l91.cast(), len93, len93);
                        let l94 = i32::from(*ptr0.add(184).cast::<u8>());
                        let l148 = i32::from(*ptr0.add(304).cast::<u8>());
                        let l160 = i32::from(*ptr0.add(316).cast::<u8>());
                        super::wavs::types::service::AggregatorSubmit {
                            url: _rt::string_lift(bytes93),
                            component: match l94 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l95 = i32::from(*ptr0.add(192).cast::<u8>());
                                        use super::wavs::types::service::ComponentSource as V119;
                                        let v119 = match l95 {
                                            0 => {
                                                let e119 = {
                                                    let l96 = *ptr0.add(196).cast::<*mut u8>();
                                                    let l97 = *ptr0.add(200).cast::<usize>();
                                                    let len98 = l97;
                                                    ...
                                                    let l99 = *ptr0.add(204).cast::<*mut u8>();
                                                    let l100 = *ptr0.add(208).cast::<usize>();
                                                    let len101 = l100;
                                            ...
                                            1 => {
                                                let e119 = {
                                                    let l102 = *ptr0.add(196).cast::<*mut u8>();
                                                    let l103 = *ptr0.add(200).cast::<usize>();
                                                    let len104 = l103;
                                                    ...
                                                    let l105 =
                                                        i32::from(*ptr0.add(204).cast::<u8>());
                                                    let l109 =
                                                        i32::from(*ptr0.add(216).cast::<u8>());
                                                    let l113 = *ptr0.add(228).cast::<*mut u8>();
                                                    let l114 = *ptr0.add(232).cast::<usize>();
                                                    let len115 = l114;
                                            ...
                                            n => {
                                                debug_assert_eq!(n, 2, "invalid enum discriminant");
                                                let e119 = {
                                                    let l116 = *ptr0.add(196).cast::<*mut u8>();
                                                    let l117 = *ptr0.add(200).cast::<usize>();
                                                    let len118 = l117;
                                        ...
                                        let l120 = i32::from(*ptr0.add(236).cast::<u8>());
                                        use super::wavs::types::service::AllowedHostPermission as V127;
                                        let v127 = match l120 {
                                            0 => V127::All,
                                            1 => {
                                                let e127 = {
                                                    let l121 = *ptr0.add(240).cast::<*mut u8>();
                                                    let l122 = *ptr0.add(244).cast::<usize>();
                                                    let base126 = l121;
                                                    let len126 = l122;
                                                    let mut result126 =
                                                        _rt::Vec::with_capacity(len126);
                                                    for i in 0..len126 {
                                                        let base = base126.add(i * 8);
                                                        let e126 = {
                                                            let l123 =
                                                                *base.add(0).cast::<*mut u8>();
                                                            let l124 = *base.add(4).cast::<usize>();
                                                            let len125 = l124;
                                                    ...
                                                    _rt::cabi_dealloc(base126, len126 * 8, 4);
                                                    result126
                                                };
                                                V127::Only(e127)
                                            }
                                        ...
                                        let l128 = i32::from(*ptr0.add(248).cast::<u8>());
                                        let l129 = i32::from(*ptr0.add(256).cast::<u8>());
                                        let l131 = i32::from(*ptr0.add(272).cast::<u8>());
                                        let l133 = *ptr0.add(288).cast::<*mut u8>();
                                        let l134 = *ptr0.add(292).cast::<usize>();
                                        let base141 = l133;
                                        let len141 = l134;
                                        let mut result141 = _rt::Vec::with_capacity(len141);
                                        for i in 0..len141 {
                                            let base = base141.add(i * 16);
                                            let e141 = {
                                                let l135 = *base.add(0).cast::<*mut u8>();
                                                let l136 = *base.add(4).cast::<usize>();
                                                let len137 = l136;
                                                ...
                                                let l139 = *base.add(12).cast::<usize>();
                                                let len140 = l139;
                                        ...
                                        _rt::cabi_dealloc(base141, len141 * 16, 4);
                                        let l142 = *ptr0.add(296).cast::<*mut u8>();
                                        let l143 = *ptr0.add(300).cast::<usize>();
                                        let base147 = l142;
                                        let len147 = l143;
                                        let mut result147 = _rt::Vec::with_capacity(len147);
                                        for i in 0..len147 {
                                            let base = base147.add(i * 8);
                                            let e147 = {
                                                let l144 = *base.add(0).cast::<*mut u8>();
                                                let l145 = *base.add(4).cast::<usize>();
                                                let len146 = l145;
                                        ...
                                        _rt::cabi_dealloc(base147, len147 * 8, 4);
                                        super::wavs::types::service::Component {
                                            source: v119,
                                            permissions: super::wavs::types::service::Permissions {
                                            ...
                                            fuel_limit: match l129 {
                                                ...
                                                1 => {
                                                    let e = {
                                                        let l130 = *ptr0.add(264).cast::<i64>();
                                                        l130 as u64
                                                    };
                                                    Some(e)
                                                }
                                            ...
                                            time_limit_seconds: match l131 {
                                                ...
                                                1 => {
                                                    let e = {
                                                        let l132 = *ptr0.add(280).cast::<i64>();
                                                        l132 as u64
                                                    };
                                                    Some(e)
                                                }
                            ...
                            evm_contracts: match l148 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l149 = *ptr0.add(308).cast::<*mut u8>();
                                        let l150 = *ptr0.add(312).cast::<usize>();
                                        let base159 = l149;
                                        let len159 = l150;
                                        let mut result159 = _rt::Vec::with_capacity(len159);
                                        for i in 0..len159 {
                                            let base = base159.add(i * 32);
                                            let e159 = {
                                                let l151 = *base.add(0).cast::<*mut u8>();
                                                let l152 = *base.add(4).cast::<usize>();
                                                let len153 = l152;
                                                ...
                                                let len156 = l155;
                                                let l157 = i32::from(*base.add(16).cast::<u8>());
                                                super::wavs::types::service::EvmContractSubmission {
                                                    chain_name: _rt::string_lift(bytes153),
                                                    address:
                                                        super::wavs::types::chain::EvmAddress {
                                                            raw_bytes: _rt::Vec::from_raw_parts(
                                                                l154.cast(),
                                                                len156,
                                                                len156,
                                        ...
                                        _rt::cabi_dealloc(base159, len159 * 32, 8);
                                        result159
                                    };
                                    Some(e)
                                }
                            ...
                            cosmos_contracts: match l160 {
                                0 => None,
                                1 => {
                                    let e = {
                                        let l161 = *ptr0.add(320).cast::<*mut u8>();
                                        let l162 = *ptr0.add(324).cast::<usize>();
                                        let base172 = l161;
                                        let len172 = l162;
                                        let mut result172 = _rt::Vec::with_capacity(len172);
                                        for i in 0..len172 {
                                            let base = base172.add(i * 40);
                                            let e172 = {
                                                let l163 = *base.add(0).cast::<*mut u8>();
                                                let l164 = *base.add(4).cast::<usize>();
                                                let len165 = l164;
                                                ...
                                                let l166 = *base.add(8).cast::<*mut u8>();
                                                let l167 = *base.add(12).cast::<usize>();
                                                let len168 = l167;
                                                ...
                                                let l170 = i32::from(*base.add(24).cast::<u8>());
                                                super::wavs::types::service::CosmosContractSubmission {
                                                    chain_name: _rt::string_lift(bytes165),
                                                    address: super::wavs::types::chain::CosmosAddress {
                                                        bech32_addr: _rt::string_lift(bytes168),
                                                        prefix_len: l169 as u32,
                                                    },
                                                    max_gas: match l170 {
                                                        0 => None,
                                                        1 => {
                                        ...
                                        _rt::cabi_dealloc(base172, len172 * 40, 8);
                                        result172
                                    };
                                    Some(e)
                                }
                    ...
                    V173::Aggregator(e173)
                }
            };
            let l174 = *ptr0.add(328).cast::<*mut u8>();
            let l175 = *ptr0.add(332).cast::<usize>();
            let len176 = l175;
            let bytes176 = _rt::Vec::from_raw_parts(l174.cast(), len176, len176);
            super::wavs::worker::helpers::WorkflowAndWorkflowId {
                workflow: super::wavs::types::service::Workflow {
                    trigger: v36,
                    component: super::wavs::types::service::Component {
                        source: v61,
                        permissions: super::wavs::types::service::Permissions {
                            allowed_http_hosts: v69,
                            file_system: _rt::bool_lift(l70 as u8),
                        },
                        fuel_limit: match l71 {
                            0 => None,
                            1 => {
                                let e = {
                                    let l72 = *ptr0.add(128).cast::<i64>();
                                    l72 as u64
                                };
                                Some(e)
                            }
                        ...
                        time_limit_seconds: match l73 {
                            0 => None,
                            1 => {
                                let e = {
                                    let l74 = *ptr0.add(144).cast::<i64>();
                                    l74 as u64
                                };
                                Some(e)
                            }
                ...
                workflow_id: _rt::string_lift(bytes176),
            }
        }
    }
}
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:wavs:worker@0.5.1:wavs-world:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 20402] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb0\x9e\x01\x01A\x02\
\x01A~\x01B\x04\x01s\x04\0\x06digest\x03\0\0\x01r\x01\x05nanosw\x04\0\x09timesta\
mp\x03\0\x02\x03\0\x15wavs:types/core@0.5.1\x05\0\x01B\x13\x01s\x04\0\x0achain-n\
ame\x03\0\0\x01r\x02\x0bbech32-addrs\x0aprefix-leny\x04\0\x0ecosmos-address\x03\0\
\x02\x01o\x02ss\x01p\x04\x01r\x02\x02tys\x0aattributes\x05\x04\0\x0ccosmos-event\
\x03\0\x06\x01ks\x01r\x07\x08chain-ids\x0crpc-endpoint\x08\x0dgrpc-endpoint\x08\x11\
grpc-web-endpoint\x08\x09gas-pricev\x09gas-denoms\x0dbech32-prefixs\x04\0\x13cos\
mos-chain-config\x03\0\x09\x01p}\x01r\x01\x09raw-bytes\x0b\x04\0\x0bevm-address\x03\
\0\x0c\x01p\x0b\x01r\x02\x06topics\x0e\x04data\x0b\x04\0\x12evm-event-log-data\x03\
\0\x0f\x01r\x03\x08chain-ids\x0bws-endpoint\x08\x0dhttp-endpoint\x08\x04\0\x10ev\
m-chain-config\x03\0\x11\x03\0\x16wavs:types/chain@0.5.1\x05\x01\x02\x03\0\0\x06\
digest\x02\x03\0\0\x09timestamp\x02\x03\0\x01\x0achain-name\x02\x03\0\x01\x0bevm\
-address\x02\x03\0\x01\x0ecosmos-address\x01BK\x02\x03\x02\x01\x02\x04\0\x06dige\
st\x03\0\0\x02\x03\x02\x01\x03\x04\0\x09timestamp\x03\0\x02\x02\x03\x02\x01\x04\x04\
\0\x0achain-name\x03\0\x04\x02\x03\x02\x01\x05\x04\0\x0bevm-address\x03\0\x06\x02\
\x03\x02\x01\x06\x04\0\x0ecosmos-address\x03\0\x08\x01s\x04\0\x0aservice-id\x03\0\
\x0a\x01s\x04\0\x0bworkflow-id\x03\0\x0c\x01s\x04\0\x0bpackage-ref\x03\0\x0e\x01\
s\x04\0\x0esemver-version\x03\0\x10\x01q\x02\x06active\0\0\x06paused\0\0\x04\0\x0e\
service-status\x03\0\x12\x01r\x02\x0achain-name\x05\x07address\x07\x04\0\x0bevm-\
manager\x03\0\x14\x01r\x02\x0achain-name\x05\x07address\x09\x04\0\x0ecosmos-mana\
ger\x03\0\x16\x01q\x02\x03evm\x01\x15\0\x06cosmos\x01\x17\0\x04\0\x0fservice-man\
ager\x03\0\x18\x01r\x02\x03urls\x06digest\x01\x04\0\x19component-source-download\
\x03\0\x1a\x01ks\x01k\x11\x01r\x04\x06digest\x01\x06domain\x1c\x07version\x1d\x03\
pkg\x0f\x04\0\x08registry\x03\0\x1e\x01q\x03\x08download\x01\x1b\0\x08registry\x01\
\x1f\0\x06digest\x01\x01\0\x04\0\x10component-source\x03\0\x20\x01ps\x01q\x03\x03\
all\0\0\x04only\x01\"\0\x04none\0\0\x04\0\x17allowed-host-permission\x03\0#\x01r\
\x02\x12allowed-http-hosts$\x0bfile-system\x7f\x04\0\x0bpermissions\x03\0%\x01kw\
\x01o\x02ss\x01p(\x01r\x06\x06source!\x0bpermissions&\x0afuel-limit'\x12time-lim\
it-seconds'\x06config)\x08env-keys\"\x04\0\x09component\x03\0*\x01p}\x01r\x03\x07\
address\x07\x0achain-name\x05\x0aevent-hash,\x04\0\x1atrigger-evm-contract-event\
\x03\0-\x01r\x03\x07address\x09\x0achain-name\x05\x0aevent-types\x04\0\x1dtrigge\
r-cosmos-contract-event\x03\0/\x01r\x04\x0achain-name\x05\x08n-blocksy\x0bstart-\
block'\x09end-block'\x04\0\x16trigger-block-interval\x03\01\x01k\x03\x01r\x03\x08\
schedules\x0astart-time3\x08end-time3\x04\0\x0ctrigger-cron\x03\04\x01q\x05\x12e\
vm-contract-event\x01.\0\x15cosmos-contract-event\x010\0\x0eblock-interval\x012\0\
\x04cron\x015\0\x06manual\0\0\x04\0\x07trigger\x03\06\x01r\x03\x0achain-name\x05\
\x07address\x07\x07max-gas'\x04\0\x17evm-contract-submission\x03\08\x01r\x03\x0a\
chain-name\x05\x07address\x09\x07max-gas'\x04\0\x1acosmos-contract-submission\x03\
\0:\x01k+\x01p9\x01k=\x01p;\x01k?\x01r\x04\x03urls\x09component<\x0devm-contract\
s>\x10cosmos-contracts\xc0\0\x04\0\x11aggregator-submit\x03\0A\x01q\x02\x04none\0\
\0\x0aaggregator\x01\xc2\0\0\x04\0\x06submit\x03\0C\x01r\x03\x07trigger7\x09comp\
onent+\x06submit\xc4\0\x04\0\x08workflow\x03\0E\x01o\x02\x0d\xc6\0\x01p\xc7\0\x01\
r\x04\x04names\x09workflows\xc8\0\x06status\x13\x07manager\x19\x04\0\x07service\x03\
\0I\x03\0\x18wavs:types/service@0.5.1\x05\x07\x02\x03\0\x02\x0aservice-id\x02\x03\
\0\x02\x0bworkflow-id\x02\x03\0\x02\x07trigger\x02\x03\0\x01\x12evm-event-log-da\
ta\x02\x03\0\x01\x0ccosmos-event\x01B!\x02\x03\x02\x01\x03\x04\0\x09timestamp\x03\
\0\0\x02\x03\x02\x01\x08\x04\0\x0aservice-id\x03\0\x02\x02\x03\x02\x01\x09\x04\0\
\x0bworkflow-id\x03\0\x04\x02\x03\x02\x01\x0a\x04\0\x07trigger\x03\0\x06\x02\x03\
\x02\x01\x04\x04\0\x0achain-name\x03\0\x08\x02\x03\x02\x01\x05\x04\0\x0bevm-addr\
ess\x03\0\x0a\x02\x03\x02\x01\x0b\x04\0\x12evm-event-log-data\x03\0\x0c\x02\x03\x02\
\x01\x06\x04\0\x0ecosmos-address\x03\0\x0e\x02\x03\x02\x01\x0c\x04\0\x0ccosmos-e\
vent\x03\0\x10\x01r\x03\x0aservice-id\x03\x0bworkflow-id\x05\x07trigger\x07\x04\0\
\x0etrigger-config\x03\0\x12\x01r\x04\x10contract-address\x0b\x0achain-name\x09\x03\
log\x0d\x0cblock-heightw\x04\0\x1ftrigger-data-evm-contract-event\x03\0\x14\x01r\
\x04\x10contract-address\x0f\x0achain-name\x09\x05event\x11\x0cblock-heightw\x04\
\0\"trigger-data-cosmos-contract-event\x03\0\x16\x01r\x02\x0achain-name\x09\x0cb\
lock-heightw\x04\0\x1btrigger-data-block-interval\x03\0\x18\x01r\x01\x0ctrigger-\
time\x01\x04\0\x11trigger-data-cron\x03\0\x1a\x01p}\x01q\x05\x12evm-contract-eve\
nt\x01\x15\0\x15cosmos-contract-event\x01\x17\0\x0eblock-interval\x01\x19\0\x04c\
ron\x01\x1b\0\x03raw\x01\x1c\0\x04\0\x0ctrigger-data\x03\0\x1d\x01r\x02\x06confi\
g\x13\x04data\x1e\x04\0\x0etrigger-action\x03\0\x1f\x03\0\x17wavs:worker/input@0\
.5.1\x05\x0d\x02\x03\0\x03\x0etrigger-action\x03\0\x0etrigger-action\x03\0\x0e\x01\
B\x04\x01p}\x01kw\x01r\x02\x07payload\0\x08ordering\x01\x04\0\x0dwasm-response\x03\
\0\x02\x03\0\x18wavs:worker/output@0.5.1\x05\x10\x02\x03\0\x04\x0dwasm-response\x03\
\0\x0dwasm-response\x03\0\x11\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\0\x01@\x01\
...
\x04\0\x04poll\x01\x06\x03\0\x12wasi:io/poll@0.2.0\x05\x13\x02\x03\0\x05\x08poll\
...
\x02\x03\0\x13wasi:io/error@0.2.0\x05\x16\x02\x03\0\x07\x05error\x01B(\x02\x03\x02\
...
\x18\x03\0\x15wasi:io/streams@0.2.0\x05\x18\x02\x03\0\x06\x08duration\x02\x03\0\x08\
\x0cinput-stream\x02\x03\0\x08\x0doutput-stream\x01B\xc0\x01\x02\x03\x02\x01\x19\
...
e\x01\x8c\x01\x03\0\x15wasi:http/types@0.2.0\x05\x1c\x02\x03\0\x09\x10outgoing-r\
equest\x02\x03\0\x09\x0frequest-options\x02\x03\0\x09\x18future-incoming-respons\
e\x02\x03\0\x09\x0aerror-code\x01B\x0f\x02\x03\x02\x01\x1d\x04\0\x10outgoing-req\
...
ttp/outgoing-handler@0.2.0\x05!\x02\x03\0\x02\x07service\x02\x03\0\x02\x08workfl\
ow\x01B\x0e\x02\x03\x02\x01\"\x04\0\x07service\x03\0\0\x02\x03\x02\x01\x08\x04\0\
\x0aservice-id\x03\0\x02\x02\x03\x02\x01#\x04\0\x08workflow\x03\0\x04\x02\x03\x02\
\x01\x09\x04\0\x0bworkflow-id\x03\0\x06\x01q\x05\x05error\0\0\x04warn\0\0\x04inf\
o\0\0\x05debug\0\0\x05trace\0\0\x04\0\x09log-level\x03\0\x08\x01r\x03\x07service\
\x01\x0aservice-id\x03\x0bworkflow-id\x07\x04\0\x17service-and-workflow-id\x03\0\
\x0a\x01r\x02\x08workflow\x05\x0bworkflow-id\x07\x04\0\x18workflow-and-workflow-\
id\x03\0\x0c\x03\0\x19wavs:worker/helpers@0.5.1\x05$\x02\x03\0\x01\x10evm-chain-\
config\x02\x03\0\x01\x13cosmos-chain-config\x02\x03\0\x0b\x09log-level\x02\x03\0\
\x0b\x17service-and-workflow-id\x02\x03\0\x0b\x18workflow-and-workflow-id\x01B\x19\
\x02\x03\x02\x01%\x04\0\x10evm-chain-config\x03\0\0\x02\x03\x02\x01&\x04\0\x13co\
smos-chain-config\x03\0\x02\x02\x03\x02\x01'\x04\0\x09log-level\x03\0\x04\x02\x03\
\x02\x01(\x04\0\x17service-and-workflow-id\x03\0\x06\x02\x03\x02\x01)\x04\0\x18w\
orkflow-and-workflow-id\x03\0\x08\x01k\x01\x01@\x01\x0achain-names\0\x0a\x04\0\x14\
get-evm-chain-config\x01\x0b\x01k\x03\x01@\x01\x0achain-names\0\x0c\x04\0\x17get\
...
i:cli/terminal-input@0.2.0\x050\x01B\x01\x04\0\x0fterminal-output\x03\x01\x03\0\x1e\
wasi:cli/terminal-output@0.2.0\x051\x02\x03\0\x12\x0eterminal-input\x01B\x06\x02\
\x03\x02\x012\x04\0\x0eterminal-input\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\
\0\x12get-terminal-stdin\x01\x04\x03\0\x1dwasi:cli/terminal-stdin@0.2.0\x053\x02\
\x03\0\x13\x0fterminal-output\x01B\x06\x02\x03\x02\x014\x04\0\x0fterminal-output\
\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stdout\x01\x04\x03\
\0\x1ewasi:cli/terminal-stdout@0.2.0\x055\x01B\x06\x02\x03\x02\x014\x04\0\x0fter\
minal-output\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stderr\
\x01\x04\x03\0\x1ewasi:cli/terminal-stderr@0.2.0\x056\x01B\x05\x01r\x02\x07secon\
dsw\x0bnanosecondsy\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\
\0\x0aresolution\x01\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.0\x057\x02\x03\0\x08\
\x05error\x02\x03\0\x17\x08datetime\x01Br\x02\x03\x02\x01\x1a\x04\0\x0cinput-str\
eam\x03\0\0\x02\x03\x02\x01\x1b\x04\0\x0doutput-stream\x03\0\x02\x02\x03\x02\x01\
8\x04\0\x05error\x03\0\x04\x02\x03\x02\x019\x04\0\x08datetime\x03\0\x06\x01w\x04\
...
system-error-code\x01T\x03\0\x1bwasi:filesystem/types@0.2.0\x05:\x02\x03\0\x18\x0a\
...
\0\x1a\x11ip-address-family\x01BD\x02\x03\x02\x01\x14\x04\0\x08pollable\x03\0\0\x02\
...
ny\x01\x0f\x03\0\x20wasi:keyvalue/batch@0.2.0-draft2\x05R\x01k\x12\x01j\x01\xd3\0\
\x01s\x01@\x01\x0etrigger-action\x0f\0\xd4\0\x04\0\x03run\x01U\x04\0\x1cwavs:wor\
ker/wavs-world@0.5.1\x04\0\x0b\x10\x01\0\x0awavs-world\x03\0\0\0G\x09producers\x01\
